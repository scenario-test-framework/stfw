...
└── stfw/               # stfw プロジェクト (stfw init 相当 + シナリオ)
    ...
    ├── plugins/            # カスタムプラグイン
    │   └── process/importMasterData/   # config 内 CSV → 組込み importPostgres へ委譲
