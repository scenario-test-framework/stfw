...
| 項目 | 内容 |
|------|------|
| イベントID | 20260712_015850_warn_first_class_status |
| 作成日時 | 2026-07-12T01:58:50 |
| ソース | Warn 一級ステータス導入（REQ-023 / SPEC-023-01/02）に伴う LR-004 の状態遷移列挙の追従（trigger_event: usdm:20260712_015850_warn_first_class_status） |
